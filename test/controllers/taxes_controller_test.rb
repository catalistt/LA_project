...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { code: @tax.code, name: @tax.name, percentage: @tax.percentage } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { code: @tax.code, name: @tax.name, percentage: @tax.percentage } }
